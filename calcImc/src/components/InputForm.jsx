...
const InputForm = ({ onCalculate }) => {
  ...
  const handleAlturaChange = (e) => {
    ...
    if (truncatedDigits.length > 1) {
      formattedValue = `${truncatedDigits.substring(
        0,
        1
      )}.${truncatedDigits.substring(1)}`;
    }
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/result"); // ← redireciona para página de resultados
  };
