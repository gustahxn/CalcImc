...
const Home = () => {
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <section
        id="info"
        className="py-20 px-6 bg-gradient-to-bl from-white to-sky-300"
      >
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <blockquote className="border-l-4 border-pink-600 pl-6 text-xl font-meidum text-slate-700 italic leading-loose tracking-wide">
              ...
              <blockquote className="border-l-4 border-pink-600 pl-6 text-xl font-medium text-slate-700 italic leading-loose tracking-wide">
