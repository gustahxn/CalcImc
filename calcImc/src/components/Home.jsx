        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <blockquote className="border-l-2 border-t-2 pt-6 border-slate-400/10 shadow-[inset_0_1px_3px_rgba(0,0,0,0.04)] pl-6 text-xl font-light text-slate-700 font-sans leading-loose tracking-wide">
              ...
              <blockquote className="border-px border-l-2 border-b-2 pt-6 border-slate-400/10 shadow-[inset_0_1px_3px_rgba(0,0,0,0.04)] pl-6 text-xl font-light text-slate-700 font-sans leading-loose tracking-wide">
