        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-3xl mx-auto mb-16 text-center">
            <h2 className="text-slate-900 text-3xl lg:text-4xl font-bold text-center mb-4 leading-relaxed">
              Descubra <span className="underline italic decoration-4 decoration-blue-600 font-bold">mais</span> sobre tudo que temos a oferecer!
            </h2>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
            <div className="text-center">
              <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-blue-50 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-blue-700 w-full h-full inline-block" viewBox="0 0 100 100">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">Personalize facilmente cada aspecto da plataforma para atender às necessidades do seu negócio. Desde ajustes de design até preferências funcionais.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-pink-50 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-pink-700 w-full h-full inline-block" viewBox="0 0 682.667 682.667">
                  <defs>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">Sua privacidade é nossa prioridade. Utilizamos criptografia padrão da indústria e detecção de ameaças em tempo real para manter seus dados protegidos.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-green-50 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-green-700 w-full h-full inline-block" viewBox="0 0 512 512">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">Todo o nosso suporte sempre disponível para te ajudar. Estamos aqui para garantir que sua experiência seja tranquila.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-purple-50 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-purple-700 w-full h-full inline-block" viewBox="0 0 512 512">
              ...
              <h3 className="text-slate-900 text-lg font-semibold mb-3">Performance</h3>
