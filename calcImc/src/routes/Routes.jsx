    ...
    <Routes>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="max-w-3xl mx-auto mb-16 text-center">
          <h2 class="text-slate-900 text-3xl lg:text-4xl font-bold text-center mb-4 leading-relaxed">Descubra <span className="italic font-semibold">mais</span> sobre tudo que temos a oferece!</h2>
