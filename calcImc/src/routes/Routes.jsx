    ...
    <Routes>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="max-w-3xl mx-auto mb-16 text-center">
          <h2 class="text-slate-900 text-3xl lg:text-4xl font-bold text-center mb-4 leading-relaxed">Descubra <span className="underline italic decoration-8 decoration-blue-600 font-bold">mais</span> sobre tudo que temos a oferece!</h2>
          <p class="text-slate-600 text-sm leading-relaxed">Mergulhe nesse mundo de vastas oportunidades, dicas de cuidado e planeje seu próximo passo na busca por uma saúde melhor. Seja <span className="text-blue-600 font-bold hover:text-blue-800">SoroFitness</span></p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div class="text-center">
            ...
            <h3 class="text-slate-900 text-lg font-semibold mb-3">Customização </h3>
            <p class="text-slate-600 text-sm leading-relaxed">  Personalize facilmente cada aspecto da plataforma para atender às necessidades do seu negócio. Desde ajustes de design até preferências funcionais.</p>
          </div>

          <div class="text-center">
            <div class="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-pink-50 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="text-pink-700 w-full h-full inline-block" viewBox="0 0 682.667 682.667">
                <defs>
            ...
            <h3 class="text-slate-900 text-lg font-semibold mb-3">Segurança</h3>
            <p class="text-slate-600 text-sm leading-relaxed">Sua privacidade é nossa prioridade. Utilizamos criptografia padrão da indústria e detecção de ameaças em tempo real para manter seus dados protegidos.</p>
          </div>

          <div class="text-center">
            <div class="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-green-50 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="fill-green-700 w-full h-full inline-block" viewBox="0 0 512 512">
            ...
            <h3 class="text-slate-900 text-lg font-semibold mb-3">Suporte</h3>
            <p class="text-slate-600 text-sm leading-relaxed">Todo o nosso suporte sempre disponível para te ajudar. Estamos aqui para garantir que sua experiência seja tranquila.</p>
          </div>

          <div class="text-center">
            <div class="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-purple-50 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="fill-purple-700 w-full h-full inline-block" viewBox="0 0 512 512">
            ...
            <p class="text-slate-600 text-sm leading-relaxed">Desfrute de funcionalidades e dicas repletas de valor e honestidade. Nosso projeto foi criado para entregar resultados sem lentidão.</p>
          </div>

          <div class="text-center">
            <div class="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-orange-50 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="text-orange-700 w-full h-full inline-block" viewBox="0 0 682.667 682.667">
                <defs>
          ...
          <div class="text-center">
            <div class="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-blue-50 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-700 w-full h-full inline-block" viewBox="0 0 682.667 682.667">
                <defs>
                  <clipPath id="a" clipPathUnits="userSpaceOnUse">
                            <path d="M0 512h512V0H0Z" data-original="#000000" />
                          </clipPath>
